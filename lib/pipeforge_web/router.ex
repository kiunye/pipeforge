defmodule PipeForgeWeb.Router do
  use PipeForgeWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {PipeForgeWeb.Layouts, :root}
  ...
  # scope "/api", PipeForgeWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard in development
  if Application.compile_env(:pipeforge, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PipeForgeWeb.Telemetry
    end
  end
end
